...
#create_generated_clock -name EN_clk [-master_clock sys_clk_pin] -add [get_ports clk_EN]


set_output_delay -clock sys_clk_pin 2 [get_ports {LED[0]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {LED[1]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {LED[2]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {LED[3]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {LED[4]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {SEG[0]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {SEG[1]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {SEG[2]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {SEG[3]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {SEG[4]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {SEG[5]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {SEG[6]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {AN[0]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {AN[1]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {AN[2]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {AN[3]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {AN[4]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {AN[5]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {AN[6]}]
set_output_delay -clock sys_clk_pin 2 [get_ports {AN[7]}]
set_input_delay -clock sys_clk_pin 2 [get_ports {clkEN}]
...
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { OP }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { clkEN }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn

#set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { clkEN }]; #IO_L9P_T1_DQS_14 Sch=btnc
